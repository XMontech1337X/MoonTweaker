...
namespace MoonTweaker
{
    public partial class App : Application
    {
        ...
        {
            Language = RegistryHelp.GetValue(@"HKEY_CURRENT_USER\Software\MoonTweaker", "Language", GettingSystemLanguage);
            Theme = RegistryHelp.GetValue(@"HKEY_CURRENT_USER\Software\MoonTweaker", "Theme", "Dark");
        }
