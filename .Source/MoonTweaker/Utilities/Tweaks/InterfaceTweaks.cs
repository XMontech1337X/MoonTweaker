...
namespace MoonTweaker.Utilities.Tweaks
{
    internal sealed class InterfaceTweaks
    {
        internal void AnalyzeAndUpdate(InterfaceView interfaceV)
        {
            ...
            interfaceV.TglButton33.StateNA =
        ...
        internal static void ApplyTweaks(string tweak, bool isChoose)
        {
            ...
            switch (tweak)
            {
                ...
                case "TglButton32":
                    ...
                    break;
                case "TglButton33":
                    RegistryHelp.Write(Registry.CurrentUser, @"Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced", "Hidden", isChoose ? 2 : 1, RegistryValueKind.DWord);
                    break;
