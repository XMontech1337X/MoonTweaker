...
namespace MoonTweaker.Utilities.Tweaks
{
    internal sealed class ServicesTweaks : Firewall
    {
        ...
        {
            { "Uso", ("usoclient.exe", "BlockUOrchestrator-MoonTweaker.exe") },
            { "Worker", ("MoUsoCoreWorker.exe", "BlockUpdate-MoonTweaker.exe") },
            { "Core", ("wuaucltcore.exe", "BlockUpdateCore-MoonTweaker.exe") },
            { "Agent", ("WaaSMedicAgent.exe", "BlockUpdateAgent-MoonTweaker.exe") }
        };
