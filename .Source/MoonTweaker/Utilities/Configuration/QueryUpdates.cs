...
namespace MoonTweaker.Utilities.Configuration
{
    internal sealed class QueryUpdates
    {
        ...
        internal void RunSearch()
        {
            ...
            try
            {
                HttpWebRequest webRequest = (HttpWebRequest)WebRequest.Create("https://api.github.com/repos/XMontech1337X/MoonTweaker/releases/latest");
